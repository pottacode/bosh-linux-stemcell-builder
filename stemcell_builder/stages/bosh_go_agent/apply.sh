...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.268.3-sl-linux-amd64"
  echo "22c35242223d4fcbc95983c7bcdbd9ed31f751cd  bosh-agent" | shasum -c -
fi
