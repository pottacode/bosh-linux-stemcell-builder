...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.268.7-sl-linux-amd64"
  echo "380cfc98926b30c2fa6aa64dbc12e902cdc1b064  bosh-agent" | shasum -c -
fi
