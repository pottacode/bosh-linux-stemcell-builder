...
if is_ppc64le; then
  ...
  curl -L -o bosh-agent "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.117.0-ng.24-linux-amd64"
  echo "5808ba6a1385444119b9727520c017500829c59b39af0f6c531b6fee8293eebc  bosh-agent" | shasum -a 256 -c -
fi
