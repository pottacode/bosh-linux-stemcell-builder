...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.215.3-sl-linux-amd64"
  echo "89e529deded2d25ace268e85e9e89f635abcde53  bosh-agent" | shasum -c -
fi
