...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.234.2-sl-linux-amd64"
  echo "48d013cf194d154308e805316f9e34fb762e48b4  bosh-agent" | shasum -c -
fi
