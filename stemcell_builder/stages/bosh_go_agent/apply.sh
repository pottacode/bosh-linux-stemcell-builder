...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.234.1-sl-linux-amd64"
  echo "2746d16944a0e3b799f81d91ec431b457dad942c  bosh-agent" | shasum -c -
fi
