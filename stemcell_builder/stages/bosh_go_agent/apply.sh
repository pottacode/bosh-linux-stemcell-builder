...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.268.17-sl-linux-amd64"
  echo "cd5226c5552b22d7c6aec705232ea43dfab87f02  bosh-agent" | shasum -c -
fi
