...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.268.20-sl-linux-amd64"
  echo "7ceb1c773ac5b426b8f3ee53f1c87e17cf2e3c6e  bosh-agent" | shasum -c -
fi
