...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.215.3.1-sl-linux-amd64"
  echo "e4c2ae6d9b001f522a9d05ea96310a4ddff8da2b  bosh-agent" | shasum -c -
fi
