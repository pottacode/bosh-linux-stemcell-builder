...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.268.15-sl-linux-amd64"
  echo "862621d9a41abbf72d45bc98c0399109ce09ff02  bosh-agent" | shasum -c -
fi
