...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.268.9-sl-linux-amd64"
  echo "75c95495d54e4485f38ecb9e58a6ebcde0cfe04d  bosh-agent" | shasum -c -
fi
