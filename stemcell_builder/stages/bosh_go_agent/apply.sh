...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.268.19-sl-linux-amd64"
  echo "ee974f7c6d8ad7d897245ef77d5ff25f6e720e84  bosh-agent" | shasum -c -
fi
