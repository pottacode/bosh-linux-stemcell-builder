...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.268.5-sl-linux-amd64"
  echo "3523c307450e9d09edcec2b0dd8dcb5edd47a1e0  bosh-agent" | shasum -c -
fi
