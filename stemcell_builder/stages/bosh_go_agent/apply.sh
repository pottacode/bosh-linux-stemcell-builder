...
if is_ppc64le; then
  ...
  curl -L -o bosh-agent "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.117.0-ng.31-linux-amd64"
  echo "161c9a422f03e4282f6185268a38f2998c88f30ba7b2f0e7fb88799ccc86d3a6  bosh-agent" | shasum -a 256 -c -
fi
