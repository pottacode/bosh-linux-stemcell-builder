...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.268.21-sl-linux-amd64"
  echo "6c997eb2ca94ca4e8b7cbbb2fbe1c403ee536ac5  bosh-agent" | shasum -c -
fi
