...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.234.3-sl-linux-amd64"
  echo "52211a0832379446db95ce259a10bab531f81741  bosh-agent" | shasum -c -
fi
