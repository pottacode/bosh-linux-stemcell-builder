...
if is_ppc64le; then
  ...
  curl -L -o bosh-agent "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.117.0-ng.22-linux-amd64"
  echo "d125342320d5c35676ef7ff134a123db78115c38c9555f4298518025410bb33a  bosh-agent" | shasum -a 256 -c -
fi
