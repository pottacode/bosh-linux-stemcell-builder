...
curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.333.0-sl-linux-amd64"
echo "fbc0d3ea80a7bbfa09c1f7f4f383157661ba5a17  bosh-agent" | shasum -c -
