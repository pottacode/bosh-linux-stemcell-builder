...
curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.386.0-sl-linux-amd64"
echo "7047036e50f10cf2282039805a0ba24a93296a96  bosh-agent" | shasum -c -
