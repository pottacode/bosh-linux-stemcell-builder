...
if is_ppc64le; then
  ...
  curl_it "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.268.6-sl-linux-amd64"
  echo "e16deb5abeb5ae068a7c0dc9053f76c4f7a567d7  bosh-agent" | shasum -c -
fi
