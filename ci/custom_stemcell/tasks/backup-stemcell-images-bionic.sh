...
private_image_name="backup-private-image-for-custom-bosh-stemcell-bionic-${stemcell_version}"
public_image_name="backup-public-image-for-custom-bosh-stemcell-bionic-${stemcell_version}"
