...
private_image_name=private-image-for-custom-bosh-stemcell-bionic-${custom_stemcell_version}
public_image_name=public-image-for-custom-bosh-stemcell-bionic-${custom_stemcell_version}
...
echo "The private image id is ${private_image_id}"
