...
image_os_code=UBUNTU_16_64
# private_image_name must be fewer than 64 characters
private_image_name=private-image-imported-from-${CANDIDATE_BUILD_NUMBER}-vhd
private_image_note="Private image imported form COS ${stemcell_vhd_filename}"
public_image_name=public-image-for-light-bosh-stemcell-${CANDIDATE_BUILD_NUMBER}
public_image_note="Public image for light bosh stemcell ${CANDIDATE_BUILD_NUMBER}"
